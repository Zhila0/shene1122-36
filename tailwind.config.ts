		...
		extend: {
			colors: {
				...
				quiz: {
					...
					completed: 'hsl(var(--quiz-completed))'
				},
				timer: {
					normal: 'hsl(var(--timer-normal))',
					warning: 'hsl(var(--timer-warning))',
					orange: 'hsl(var(--timer-orange))',
			...
			boxShadow: {
				...
				'answer-box': 'var(--shadow-answer-box)',
				'answer-hover': 'var(--shadow-answer-hover)',
			},
			backgroundImage: {
			...
			animation: {
				...
				'timer-tick': 'timer-tick 60s linear',
				'pulse-answer': 'pulse-answer 0.2s ease-in-out',
